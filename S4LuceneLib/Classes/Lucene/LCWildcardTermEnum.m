 ...
 *
 * @version $Id: LCWildcardTermEnum.m 2722 2008-01-03 12:38:19Z mguesdon $
 */
...
- (id) initWithReader: (LCIndexReader *) reader term: (LCTerm *) term
{
	...
	regexp = [[NSRegularExpression alloc] initWithPattern: [NSString stringWithFormat: @"^%@$", ms] options: 0  error: &error];
...
- (BOOL)wildcardEqualsTo: (NSString *)string
{
	NSUInteger					numberOfMatches;

	numberOfMatches = [regexp numberOfMatchesInString: string options: 0 range: NSMakeRange(0, [string length])];
