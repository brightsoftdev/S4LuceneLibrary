 ...
 * @since   lucene 1.4
 * @version $Id: LCSort.m 324 2005-10-06 21:16:28Z qmathe $
 */
...
{
	return AUTORELEASE([[LCSort alloc] init]);
}

+ (LCSort *) sort_INDEXORDER
{
	return AUTORELEASE([[LCSort alloc] initWithSortField: [LCSortField sortField_DOC]]);
}
